...
const FormContactBanner = ({ formname }) => {
  ...
  return (
    ...
    >
      ...
      <Form.Row>
        <Form.Group as={Col} controlId="formContactBannerFirstName">
          <Form.Control
            name="firstName"
            type="text"
            value={firstName}
        ...
        <Form.Group as={Col} controlId="formContactBannerLastName">
          <Form.Control
            name="lastName"
            type="text"
            value={lastName}
      ...
      <Form.Row>
        <Form.Group as={Col} controlId="formContactBannerPhone">
          <Form.Control
            name="phone"
            type="tel"
            value={phone}
        ...
        <Form.Group as={Col} controlId="formContactBannerEmail">
          <Form.Control
            name="email"
            type="email"
            value={email}
      ...
      <Form.Row>
        <Form.Group as={Col} controlId="formContactBannerProjectLocation">
          <Form.Control
        ...
        <Form.Group as={Col} controlId="formContactBannerProjectType">
          <Form.Control
            name="projectType"
            as="select"
            value={projectType}
      ...
      <Form.Row>
        <Form.Group as={Col} controlId="formContactBannerFindUs">
          <Form.Control
            name="findUs"
            as="select"
            value={findUs}
