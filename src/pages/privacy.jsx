    ...
    <Layout>
      ...
      <section id="about-page">
        <Container className="p-lg-5">
          ...
          <p>
            It is MDH Construction's policy to respect your privacy regarding
            any information We may collect while operating Our website. This
            Privacy Policy applies to{' '}
            <Link to="/">https://www.mdhconstruction.com</Link> (hereinafter,
            "We", "Us", "Our" or "
            <Link to="/">https://www.mdhconstruction.com</Link>"). We respect
            your privacy and We're committed to protecting personally
          ...
          <h3 className="text-left pt-5 pb-4">Website Visitors</h3>
          <p>
            Like most website operators, MDH Construction collects
            non-personally-identifying information of the sort that web browsers
            and servers typically make available, such as the browser type,
            language preference, referring site, and the date and time of each
            visitor request. MDH Construction's purpose in collecting
            non-personally identifying information is to better understand how
            MDH Construction's visitors use Our website. From time to time, MDH
            Construction may release non-personally-identifying information in
          ...
          <p>
            ...
            Construction only discloses logged in user and commenter IP
          ...
          <p>
            Certain visitors to MDH Construction's website choose to interact
            with MDH Construction in ways that require MDH Construction to
            gather personally-identifying information. The amount and type of
            information that MDH Construction gathers depends on the nature of
            the interaction. For example, We ask visitors who sign up for a blog
            at <Link to="/">https://www.mdhconstruction.com</Link> to provide a
          ...
          <h3 className="text-left pt-5 pb-4">Links To External Sites</h3>
          <p>
          ...
          <h3 className="text-left pt-5 pb-4">Aggregated Statistics</h3>
          <p>
            MDH Construction may collect statistics about the behavior of
            visitors to our website. MDH Construction may display this
            information publicly or provide it to others. However, MDH
            Construction does not disclose your personally-identifying
            information.
          </p>
          <h3 className="text-left pt-5 pb-4">Cookies</h3>
          <p>
            To enrich and perfect your online experience, MDH Construction uses
          ...
          <p>
            ...
            <Link to="/">https://www.mdhconstruction.com</Link>, and their
            website access preferences. MDH Construction visitors who do not
            wish to have cookies placed on their computers should set their
            browsers to refuse cookies before using MDH Construction's websites,
            with the drawback that certain features of MDH Construction's
            websites may not function properly without the aid of cookies.
          </p>
          <p>
            By continuing to navigate Our website without changing your cookie
            settings, you hereby acknowledge and agree to MDH Construction's use
            of cookies.
          </p>
          <h3 className="text-left pt-5 pb-4">Privacy Policy Changes</h3>
          <p>
            Although most changes are likely to be minor, MDH Construction may
            change its Privacy Policy from time to time, and in MDH
            Construction's sole discretion. MDH Construction encourages visitors
