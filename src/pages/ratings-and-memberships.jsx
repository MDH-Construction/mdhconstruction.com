...
import ImgMassSave from '../components/images/logos/img-mass-save';
          ...
          <Row className=" px-0 mx-0">
            ...
            >
              <Container className="py-5 px-lg-5">
                ...
                <p>
                  The Better Business Bureau (BBB) has been the gold standard
                  for consumers to check a company's credibility since 1912.
                </p>
                <p>
                  <strong>
                    Our A+ grade represents the BBB’s strong degree of
                    confidence that MDH Construction is operating in a
                    trustworthy manner and will make a good faith effort to
                    resolve any customer concerns filed with the BBB.
                  </strong>
                </p>
            ...
            >
              <Container className="py-5 px-lg-5">
                ...
                <p className="text-white">
                  HomeAdvisor is an online marketplace with the goal of
                  connecting homeowners with local service professionals. Each
                  company is prescreened before they can be selected to complete
                  home improvement, maintenance and remodeling projects.
                </p>
                <p className="text-white">
                  <strong>
                    MDH Construction is proud to display our badges that clearly
                    demonstrate our reliability and trustworthiness as a
                    company.
                  </strong>
                </p>
        ...
        <Container fluid className="px-0 mx-0">
          <Row className=" px-0 mx-0">
            <Col
              xs={12}
              lg={6}
              className="bg-dark mx-0 px-0 order-4 order-lg-3"
            >
              <Container className="py-5 px-lg-5">
                ...
                <p className="text-white">
                  <strong>
                    MDH Construction has been an A-rated company with Angie's
                    List since May 2014 based on our customer reviews and
                    satisfactions.
                  </strong>
                </p>
                <Row className="mt-5 mb-3 mx-auto text-center drop-shadow">
